...
PATH=/home/patrick/javascript/node/bin:/opt/android-studio/bin:/usr/local/go/bin:${HOME}/.pyenv/shims:${HOME}/venv/main/bin:${HOME}/tools/scripts:/usr/local/bin:${PATH}:/usr/sbin:/sbin
